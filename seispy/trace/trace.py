...
class Trace(TimeSeries):
    ...
    def get_coordinates(self):
        ...
        return np.asarray(coord_dict[staname])
...
coord_dict['ORO'] = [44.343499, -103.7523, 1543, 0]
coord_dict['ROSS'] = [44.345099, -103.7576, 1628, 0]
coord_dict['RRDG'] = [44.359499, -103.7654, 1677, 0]
coord_dict['SHL'] = [44.316899, -103.7098, 1772, 0]
coord_dict['TPK'] = [44.340799, -103.7980, 1740, 0]
coord_dict['WTP'] = [44.353899, -103.7423, 1555, 0]
coord_dict['YATES'] = [44.352199, -103.7515, 1625, 0]
coord_dict['300'] = [44.346399, -103.7569, 1505.1, 91.44]
coord_dict['800'] = [44.347399, -103.7589, 1350, 243.84]
coord_dict['1700'] = [44.351699, -103.7584, 1073.8, 518.16]
coord_dict['A2000'] = [44.351099, -103.7623, 983.3, 609.6]
coord_dict['B2000'] = [44.349199, -103.7605, 983.3, 609.6]
coord_dict['C2000'] = [44.351599, -103.7637, 983.1, 609.6]
coord_dict['D2000'] = [44.353299, -103.7689, 983.0, 609.6]
coord_dict['E2000'] = [44.356399, -103.7716, 983.1, 609.6]
coord_dict['A4100'] = [44.344899, -103.7535, 342.5, 1249.68]
coord_dict['C4100'] = [44.351199, -103.7507, 342.3, 1249.68]
coord_dict['D4100'] = [44.343599, -103.7511, 342.5, 1249.68]
coord_dict['A4850'] = [44.340499, -103.7625, 115.2, 1478.28]
