...
def homestake(keylist=None,origin=None,coords='depth'):
    ...
    if coords=='depth':
        xyz_list = {'DEAD':  [599316.496208, 4915135.795515, 0],
                    ...
                    'A4850': [598646.478984, 4910437.175145, 1249.68],
                    'B4850': [598987.461619, 4911086.715912, 1249.68],
                    'C4850': [599409.907522, 4911093.130999, 1249.68],
                    'D4850': [599581.886292, 4911840.127688, 1249.68]}
    elif coords=='utc':
